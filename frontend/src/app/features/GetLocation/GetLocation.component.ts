...
import { GetLocationService } from './GetLocation.service.gen'
import { GetLocationGen } from './GetLocation.gen'
import screenSchema from '../../../generate-ui/overlays/GetLocation.screen.json'
...
export class GetLocationComponent extends GetLocationGen {
  constructor(
    protected override fb: FormBuilder,
    protected override service: GetLocationService
  ) {
    super(fb, service)
