...
import { GetCharacterByIdService } from './GetCharacterById.service.gen'
import { GetCharacterByIdGen } from './GetCharacterById.gen'
import screenSchema from '../../../generate-ui/overlays/GetCharacterById.screen.json'

@Component({
  selector: 'app-get-character-by-id',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './GetCharacterById.component.html',
  styleUrls: ['./GetCharacterById.component.scss']
})
export class GetCharacterByIdComponent extends GetCharacterByIdGen {
  constructor(
    protected override fb: FormBuilder,
    protected override service: GetCharacterByIdService
  ) {
    super(fb, service)
