...
import { GetNameByNameGen } from './GetNameByName.gen'

@Component({
  selector: 'app-get-name-by-name',
  standalone: true,
  imports: [
    NgIf,
    NgFor,
  ...
  templateUrl: './GetNameByName.component.html',
  styleUrls: ['./GetNameByName.component.scss']
})
export class GetNameByNameComponent extends GetNameByNameGen {
  constructor(
    protected override fb: FormBuilder,
    protected override service: GetNameByNameService
  ) {
    super(fb, service)
  }
  ...
  submit() {
    ...
    const pathParams = this.pick(value, ["name"])
