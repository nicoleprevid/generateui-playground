...
import { UpdateProductService } from './UpdateProduct.service.gen'
import { UpdateProductGen } from './UpdateProduct.gen'
import screenSchema from '../../../../generate-ui/overlays/updateProduct.screen.json'
...
export class UpdateProductComponent extends UpdateProductGen implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    protected override service: UpdateProductService
  ) {
    super(fb, service)
