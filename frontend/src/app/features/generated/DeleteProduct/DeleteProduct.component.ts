...
import { DeleteProductService } from './DeleteProduct.service.gen'
import { DeleteProductGen } from './DeleteProduct.gen'
import screenSchema from '../../../../generate-ui/overlays/deleteProduct.screen.json'
...
export class DeleteProductComponent extends DeleteProductGen implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    protected override service: DeleteProductService
  ) {
    super(fb, service)
