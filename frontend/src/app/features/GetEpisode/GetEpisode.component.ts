...
import { GetEpisodeService } from './GetEpisode.service.gen'
import { GetEpisodeGen } from './GetEpisode.gen'
import screenSchema from '../../../generate-ui/overlays/GetEpisode.screen.json'

@Component({
  selector: 'app-get-episode',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './GetEpisode.component.html',
  styleUrls: ['./GetEpisode.component.scss']
})
export class GetEpisodeComponent extends GetEpisodeGen {
  constructor(
    protected override fb: FormBuilder,
    protected override service: GetEpisodeService
  ) {
    super(fb, service)
