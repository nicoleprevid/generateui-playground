...
import { GetEpisodeByIdGen } from './GetEpisodeById.gen'
import screenSchema from '../../../generate-ui/overlays/GetEpisodeById.screen.json'

@Component({
  selector: 'app-get-episode-by-id',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './GetEpisodeById.component.html',
  styleUrls: ['./GetEpisodeById.component.scss']
})
export class GetEpisodeByIdComponent extends GetEpisodeByIdGen {
  constructor(
    protected override fb: FormBuilder,
    protected override service: GetEpisodeByIdService
  ) {
    super(fb, service)
