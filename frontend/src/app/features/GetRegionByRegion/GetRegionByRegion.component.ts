...
import { GetRegionByRegionService } from './GetRegionByRegion.service.gen'
import { GetRegionByRegionGen } from './GetRegionByRegion.gen'

@Component({
  selector: 'app-get-region-by-region',
  standalone: true,
  imports: [
    NgIf,
    NgFor,
  ...
  templateUrl: './GetRegionByRegion.component.html',
  styleUrls: ['./GetRegionByRegion.component.scss']
})
export class GetRegionByRegionComponent extends GetRegionByRegionGen {
  constructor(
    protected override fb: FormBuilder,
    protected override service: GetRegionByRegionService
  ) {
    super(fb, service)
  }
  ...
  submit() {
    ...
    const pathParams = this.pick(value, ["region"])
