...
import { GetLocationByIdService } from './GetLocationById.service.gen'
import { GetLocationByIdGen } from './GetLocationById.gen'
import screenSchema from '../../../generate-ui/overlays/GetLocationById.screen.json'
...
@Component({
  ...
  templateUrl: './GetLocationById.component.html',
  styleUrls: ['./GetLocationById.component.scss']
})
export class GetLocationByIdComponent extends GetLocationByIdGen {
  constructor(
    protected override fb: FormBuilder,
    protected override service: GetLocationByIdService
  ) {
    super(fb, service)
