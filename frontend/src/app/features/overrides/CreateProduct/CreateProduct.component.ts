...
import { CreateProductService } from './CreateProduct.service.gen'
import { CreateProductGen } from './CreateProduct.gen'
import screenSchema from '../../../../generate-ui/overlays/createProduct.screen.json'
...
export class CreateProductComponent extends CreateProductGen implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    protected override service: CreateProductService
  ) {
    super(fb, service)
