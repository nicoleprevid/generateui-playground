...
import { GetProductByIdService } from './GetProductById.service.gen'
import { GetProductByIdGen } from './GetProductById.gen'
import screenSchema from '../../../../generate-ui/overlays/getProductById.screen.json'
...
@Component({
  ...
  styleUrls: ['./GetProductById.component.scss']
})
export class GetProductByIdComponent extends GetProductByIdGen implements OnInit, AfterViewInit, OnDestroy {
  private readonly autoRefresh = false
  private readonly allowDeepArraySearch = false
  ...
  constructor(
    ...
    protected override service: GetProductByIdService
  ) {
    super(fb, service)
